...
@section('content')
    <div class="p-5">
        <div class="w-full md:w-4/5 mx-auto">
            <img src="{{ config('app.client.2d_logo') }}" alt="logo" class="w-32 my-10 m-auto">
            <form action="{{ route('login.post') }}" method="POST" class="mt-5">
                ...
                <p class="text-sm font-light text-gray-500">
                    <a href="{{ route('login3d') }}" class="font-medium text-primary-600 hover:underline">3D သို့သွားရန် </a>
                </p>
            </form>
