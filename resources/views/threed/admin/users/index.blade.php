    ...
    <div class="w-full px-5 py-5 md:px-10">
            ...
            @foreach( $users as $user )
                <div class="w-full block p-3 text-dark bg-white/20 hover:bg-white/25 border border-zinc-500/30 rounded-lg shadow">
                    <div class="w-full flex justify-between">
                        ...
                        <div class="flex">
                            <a href="{{ route('threed.users.edit', $user->id) }}">
                                <i class="fa-solid fa-edit mx-5"></i>
                            </a>
                            @if( $user->id != Auth::guard('threed')->id())
                    ...
                    <div class="w-full mt-5 text-md">
                        ...
                        <div class="flex justify-between border border-slate-200/40 border-t-0 p-3">
                            <h4>သွတ် - အဆ</h4>
                            <p class="text-blue-700 font-bold"> {{ $user->setting->t_za }} </p>
                        </div>
                        <div class="flex justify-between border border-slate-200/40 border-t-0 p-3">
                            <h4>ပတ်လည် - အဆ</h4>
                            <p class="text-blue-700 font-bold"> {{ $user->setting->p_za }} </p>
                        </div>
                        <div class="flex justify-between border border-slate-200/40 border-t-0 p-3">
        ...
        <div id="drawer-bottom-example" class="lg:w-1/2 mx-auto text-center fixed bottom-0 left-0 right-0 z-40 w-full p-4 overflow-y-auto transition-transform bg-white translate-y-full transition-transform rounded-xl" tabindex="-1" aria-labelledby="drawer-bottom-label">
            ...
            <div class='my-3 w-full grid gap-10'>
                <form action="{{ route('threed.users.store') }}" method="POST" autocomplete="off">
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="number" name="t_za" id="t_za" class="bg-white border border-gray-300 text-dark text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="ဒဲ့ အဆ">
                    </div>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="number" name="p_za" id="p_za" class="bg-white border border-gray-300 text-dark text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="ပတ်လည် အဆ">
                    </div>
...
<script>
    ...
    function deleteAction(e){
        ...
        document.querySelector('#delete-form').action = `/threed/admin/users/${id}`;
    }
