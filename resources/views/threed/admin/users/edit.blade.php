...
@section('content')
    <div class="w-full px-5 py-5 md:px-10">
        ...
        <div class='my-3 w-full grid gap-10'>
            ...
            <form action="{{ route('threed.users.update', $user->id) }}" method="POST" autocomplete="off">
                ...
                <div class="relative mb-6">
                    ...
                    <input type="number" name="t_za" id="t_za" value="{{ $user->setting->t_za }}" class="bg-white border border-gray-300 text-dark text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="ဒဲ့ အဆ">
                </div>
                ...
                <div class="relative mb-6">
                    ...
                    <input type="number" name="p_za" id="p_za" value="{{ $user->setting->p_za }}" class="bg-white border border-gray-300 text-dark text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="ပတ်လည် အဆ">
                </div>
                ...
                <div class="flex gap gap-3">
                    <a href='{{ route('threed.reset.password', $user->id) }}'
