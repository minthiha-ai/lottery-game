                            ...
                            @php
                                    ...
                                    for ($j = 0; $j < 3; $j++) {
                                        for ($k = 0; $k < 3; $k++) {
                                            if ($i !== $j && $i !== $k && $j !== $k) {
                                                ...
                                                $permutation = strval($inputStr[$i] . $inputStr[$j] . $inputStr[$k]);
                                                // $per = $permutation;
                                ...
                                foreach ($data->lottery_numbers as $lotteryNumber) {
                                    foreach ($lotteryNumber->items as $item) {
                                        ...
                                        if ($item->number->number == ($lotte->win_number + 1) || $item->number->number == ($lotte->win_number - 1)) {
