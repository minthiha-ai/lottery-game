...
@section('back')
{{ route('threed.lottery.report.number.lager', $lotte->id) }}
@endsection
...
<div class="w-full px-5 py-5 md:px-10">
    ...
    <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white">
        <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
            ...
            <a href="{{ route('threed.lottery.report.number.lager', $lotte->id) }}" class="text-lg text-blue-500 flex items-center justify-center" id="totalAmount">Cancel</a>
        </div>
    </div>
</div>
@endsection
