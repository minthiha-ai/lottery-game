            ...
            <div class="w-full p-4 bg-white border rounded shadow-md font-sans">
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="p-2 text-left border-b border-gray-300">{{ $lotte->win_number }}({{ number_format($totalPriceCount, 0, '.', ',') }})</td>
                            <td class="p-2 text-right border-b border-gray-300">{{ number_format($totalWinPrice, 0, '.', ',') }}</td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
