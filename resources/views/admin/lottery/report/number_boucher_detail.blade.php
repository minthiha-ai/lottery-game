...
@section('back')
    {{ route('lottery.report.number.boucher',$lotte->id) }}
@endsection
        ...
        <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-blue-500">
            <div class="grid h-full max-w-lg grid-cols-3 mx-auto font-medium">
                <span class="text-lg text-white flex items-center justify-center">
                    ...
                    @endphp
                    @if ($previousItem)
                        <a href="{{ route('lottery.report.number.boucher.detail', ['id' => $lotte->id, 'bId' => $previousItem->id]) }}">
                            Previous
                        </a>
                    @endif
                </span>
                ...
                <span class="text-lg text-white flex items-center justify-center">
                    ...
                    @endphp
                    @if ($nextItem)
                        <a href="{{ route('lottery.report.number.boucher.detail', ['id' => $lotte->id, 'bId' => $nextItem->id]) }}">
                            Next
                        </a>
                    @endif
                </span>
