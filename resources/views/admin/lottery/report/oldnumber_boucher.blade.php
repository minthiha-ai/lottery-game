                ...
                <th class="w-full">
                    <form id="lottery-search-form" class="flex items-center">
                        <div class="relative w-full">
                            <input type="text" id="search" name="head_price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Search" required>
                        </div>
                        <a href="#" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <thead class="w-full text-xs text-gray-700 uppercase bg-gray-100">
                            <tr class="flex justify-between w-full">
                                ...
                                <th class="flex py-2 justify-between w-full">
                                    <a href="{{ route('lottery.report.number.boucher.detail',['id'=>$lotte->id, 'bId'=>$item->id]) }}">
                                    ...
                                    <form id="deleteForm{{ $item->id }}" class="d-none" action="{{ route('lottery.report.number.boucher.delete',$item->id) }}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form>
                                </th>
